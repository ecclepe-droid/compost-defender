...
@export var damage: int = 0 # the ammount of damage melee attacks do every hit  |||  10 = 10 damage per hit, 1 = 1 damage per hit
@export var seconds_between_attacks: float = 1 # how fast the melee attack reloads  |||  1 = 1 attack per second, 0.1 = 10 attacks per second
@export var hurt_box_scale: float = 1.5 # how big the range of the melee attack is  |||  1 = 100 pixels, 0.01 = 1 pixel
@export var fire_stacks_effect: int = 5 # how many stacks of fire the melee attack inflicts  |||  10 = 10 stacks of fire, 1 = 1 stack of fire
